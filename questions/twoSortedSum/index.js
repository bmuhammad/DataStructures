...
//notes
//if sum is bigger than the target shift right pointer left
//if sum is smaller than target shift left pointer right
///pointers use while loop
...
const twoSortedSum = (nums, target) => {
  ...
  while (l < r) {
    //best because loop one time no space complexit
